...
<div class="menu-bar" style="height:110px; position: fixed;z-index:100;background-color: darkcyan;">
			...
			<section id="header">
				<div class="inner">
					<h3 style="position:relative;top: 50px;"><strong>AJOUTER LA COTISATION MENSUELLE</strong></h3>	 				      
				</div>
			</section>
			      ...
			      <div>
			        ...
			        <table class="table table-sm table-bordered">
			          ...
			          <tbody>
								...
								<tr>
			            <form method="POST" action="ajouter_m.php">
			            ...
			            <td> 		 
			             ...
			             <td> 		 
			            			 ...
			            			 <input type="number" name="cotisation_annuelle" placeholder="cotisation mensuelle" value="0" class="montant" style="padding:7px; border-radius:8px; border:1px solid grey;padding: 4px;">	       	
			            </td>
			             <td> 		 
			            	<input type="text" name="titre" placeholder="- Motif -" class="montant" style="padding:7px; border-radius:8px; border:1px solid grey;padding: 4px;">	    	
			            </td>
			             <td>
