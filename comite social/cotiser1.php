<?php
  ...
  try {
   ...
   $req = $conn->prepare("INSERT INTO droit_inscription(nom,prenom,date,droit_inscription) VALUES (?,?,?,?)");
...
<div class="menu-bar" style="height:110px; position: fixed;z-index:100;background-color: darkcyan;">
			...
			<section id="header">
				<div class="inner">
					<h3 style="position:relative;top: 50px;"><strong>AJOUTER LE DROIT D'INSCRIPTION</strong></h3>	 				      
				</div>
			</section>
			      ...
			      <div>
			        ...
			        <table class="table table-sm table-bordered">
			          ...
			          <tbody>
								...
								<tr>
			            <form method="POST" action="cotiser1.php">
			            ...
			            <td> 		            
			            			 <input type="number" name="droit_inscription" placeholder="droit d'inscription" value="0" class="montant" style="padding:7px; border-radius:8px; border:1px solid grey;padding: 4px;">	       	
			            </td>
			             <td>
