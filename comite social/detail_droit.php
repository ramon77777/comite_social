...
<html lang="en">
  ...
  <body class="bg-light">
		...
		<div class="menu-bar" style="height:110px; position: fixed;z-index:100;background-color: darkcyan;">
			...
			<section id="header">
				<div class="inner">
					<h3 style="position:relative;top: 50px;"><strong>DETAIL DROIT D'INSCRIPTION</strong></h3>	 				      
					        <nav class="navbar navbar-expand-lg navbar-light bg-light">
					          <div class="container-fluid">
					            <div class="collapse navbar-collapse" id="navbarSupportedContent">
					              <form class="d-flex" style="position:relative;top:50px;" method="POST" action="r_detail_droit.php">
			...
			<div class="bd-cheatsheet container bg-body">				
			  ...
			  $termes = $conn->query("SELECT * from droit_inscription");

				while ($recherche = $termes->fetch()) {
					$_SESSION["idccc"] = $recherche["id"];
			          ...
			          <tr>
			            ...
			            <td> <?php echo $recherche["prenom"]; ?></td>
			             <td> <?php echo $recherche["date"]; ?></td>
			              <td> <?php echo $recherche["droit_inscription"]; ?></td>
			              <td>
			             	 <a href="modifier_droit.php?id=<?php echo $_SESSION["idccc"] ?>" class="button" style="padding: 3px 5px;font-size: 14px;background-color: lightcoral;">MODIFIER</a>
			             </td>
			            <td>
			             	 <a href="supprimer_droit.php?id=<?php echo $_SESSION["idccc"] ?>" class="button" style="padding: 3px 5px;font-size: 14px; background-color: lightcoral;">SUPPRIMER</a>
			            </td>
