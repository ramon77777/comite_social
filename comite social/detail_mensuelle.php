...
<div class="menu-bar" style="height:110px; position: fixed;z-index:100;background-color: darkcyan;">
			...
			<section id="header">
				<div class="inner">
					<h3 style="position:relative;top: 50px;"><strong>DETAIL COTISATION MENSUELLE</strong></h3>	 				      
					        <nav class="navbar navbar-expand-lg navbar-light bg-light">
					          <div class="container-fluid">
					            <div class="collapse navbar-collapse" id="navbarSupportedContent">
					              <form class="d-flex" style="position:relative;top:50px;" method="POST" action="r_detail_mensuelle.php">
					                <input class="form-control me-2" type="search" placeholder="nom, prenom, année(ex : 2022-05-05), motif" aria-label="Search" style="padding:7px 5px;width: 400px; text-align: center;border-radius: 10px;" name="terme">
			...
			<div class="bd-cheatsheet container bg-body">				
			  ...
			  $termes = $conn->query("SELECT * from cotisation_mensuelle");

				while ($recherche = $termes->fetch()) {
					$_SESSION["idcc"] = $recherche["id"];
			          ?>
			          ...
			          <tr>
			            ...
			            <td> <?php echo $recherche["prenom"]; ?></td>
			             <td> <?php echo $recherche["date"]; ?></td>
			              <td> <?php echo $recherche["montant"]; ?></td>
			              <td> <?php echo $recherche["titre"]; ?></td>
			               <td>
			             	 <a href="modifier_mensuelle.php?id=<?php echo $_SESSION["idcc"] ?>" class="button" style="padding: 3px 5px;font-size: 14px; background-color: lightcoral;">MODIFIER</a>
			             </td>
			              <td>
			             	 <a href="supprimer_mensuelle.php?id=<?php echo $_SESSION["idcc"] ?>" class="button" style="padding: 3px 5px;font-size: 14px; background-color: lightcoral;">SUPPRIMER</a>
			              </td>
