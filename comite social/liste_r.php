...
<html lang="en">
  <head>
  	<title>liste-comite_social</title>
		<meta charset="utf-8" />
...
<div class="menu-bar" style="height:110px; position: fixed;z-index:100;background-color: darkcyan;">
			...
			<section id="header">
				<div class="inner">
					<h3 style="position:relative;top: 50px;"><strong>RESULTAT DU MOT <strong style="color: red;"><?php  echo strtoupper($_POST["terme"]);?> </strong></strong></h3>	 				      
			  ...
			  $termes->execute(array("%".$terme."%", "%".$terme."%"));
				...
				while ($recherche = $termes->fetch()) {
					$_SESSION["idcc"] = $recherche["id"];
			          ...
			          <tr>
			            <td> <?php echo $recherche["nom_s"]." ".$recherche["prenom_s"]; ?></td>
			            <td> <?php echo $recherche["nom_b"]." ".$recherche["prenom_b"]; ?></td>
