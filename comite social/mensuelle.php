...
<div class="menu-bar" style="height:110px; position: fixed;z-index:100;background-color: darkcyan;">
			...
			<section id="header">
				<div class="inner">
					<h3 style="position:relative;top: 50px;"><strong>PAYER COTISATION MENSUELLE</strong></h3>	 				      
					        <nav class="navbar navbar-expand-lg navbar-light bg-light">
					          <div class="container-fluid">
					            <div class="collapse navbar-collapse" id="navbarSupportedContent">
					              <form class="d-flex" style="position:relative;top:50px;" method="POST" action="recherche_mensuelle.php">
			...
			<div class="bd-cheatsheet container bg-body">				
			  ...
			  $termes = $conn->query("SELECT * from adherent ");
					...
					$_SESSION["idc"] = $recherche["id"];
			          ...
			          <tr>
			            ...
			            <td> <?php echo $recherche["prenom_s"]; ?></td>
			             <td>
			             	 <a href="ajout.php?id=<?php echo $_SESSION["idc"] ?>" class="button" style="padding: 3px 5px;font-size: 14px;background-color: lightgreen;">AJOUTER</a>
			             </td>
			          </tr>
