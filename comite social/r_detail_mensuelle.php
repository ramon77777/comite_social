...
<div class="menu-bar" style="height:110px; position: fixed;z-index:100;background-color: darkcyan;">
			...
			<section id="header">
				<div class="inner">
					<h3 style="position:relative;top: 50px;"><strong>DETAIL COTISARION MENSUELLE</strong></h3>	 				      
			...
			<div class="bd-cheatsheet container bg-body">				
  			...
  			$terme = $_POST["terme"]; 			
			  $termes = $conn->prepare("SELECT * from cotisation_mensuelle where nom LIKE ? OR prenom LIKE ? OR date LIKE ? OR titre LIKE ?")
			  ;			  
			  $termes->execute(array("%".$terme."%", "%".$terme."%","%".$terme."%","%".$terme."%"));
